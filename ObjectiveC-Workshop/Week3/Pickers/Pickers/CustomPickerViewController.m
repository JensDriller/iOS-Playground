...
//  Pickers
//
//  Created by Les Walczowski on 04/11/2011.
//  Copyright (c) 2011 School of Engineering and Digital Arts. All rights reserved.
//
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        UIImage *image = [UIImage imageNamed:@"toolicon.png"];
        [tbi setImage:image];
